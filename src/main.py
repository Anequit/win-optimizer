...
registry_keys = [(r"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AxInstSV\Start", 4, winreg.REG_DWORD),
                 ...
                 (r"HKEY_CURRENT_USER\System\GameConfigStore\GameDVR_Enabled", 1, winreg.REG_DWORD),
                 ...
                 (r"HKEY_CURRENT_USER\System\GameConfigStore\GameDVR_HonorUserFSEBehaviorMode", 1, winreg.REG_DWORD),
