class Settings:
    ...
    def general_optimizations(self):
        return dict(telemetry = [r'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\DataCollection /v AllowTelemetry /t REG_DWORD /d 0 /f',
                    ...
                    startup = [r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AxInstSV /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AppMgmt /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\CertPropSvc /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\PeerDistSvc /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SCPolicySvc /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SNMPTRAP /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WebClient /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WinRM /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\WerSvc /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\PNRPsvc /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\p2psvc /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\p2pimsvc /v Start /t REG_DWORD /d 4 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SysMain /v DelayedAutoStart /t REG_DWORD /d 1 /f',
                               r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\FileSystem /v NtfsDisable8dot3NameCreation /t REG_DWORD /d 1 /f'],
                    
                    responsiveness = [r'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\BackgroundAccessApplications /v GlobalUserDisabled /t REG_DWORD /d 1 /f',
                    ...
                    autoupdate = [r'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU /v AutoInstallMinorUpdates /t REG_DWORD /d 0 /f',
                    ...
                    powerplan = [r'powercfg /s 381b4222-f694-41f0-9685-ff5bb260df2e',
    ...
    def network_optimizations(self):
        return dict(dns = [r'netsh interface ipv4 set dnsservers Wi-Fi static 8.8.8.8 primary',
                    ...
                    services = [r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\ServiceProvider /v LocalPriority /t REG_DWORD /d 4 /f',
                    ...
                    throttling = [r'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\"Windows NT"\CurrentVersion\Multimedia\SystemProfile /v NetworkThrottlingIndex /t REG_DWORD /d 4294967295 /f',
                    ...
                    adapater = [r'Set-NetTCPSetting -SettingName internet -AutoTuningLevelLocal normal',
    ...
    def gaming_optimizations(self):
        return dict(fullscreen = [r'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\GameDVR /v AppCaptureEnabled /t REG_DWORD /d 0 /f',
                    ...
                    systemProfile = [r'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\"Windows NT"\CurrentVersion\Multimedia\SystemProfile\Tasks\Games /v Affinity /t REG_DWORD /d 0 /f',
                                     ...
                                     r'reg add (r"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\"Windows NT"\CurrentVersion\Multimedia\SystemProfile\Tasks\Games /v Scheduling Category /t REG_SZ /d High /f',
                    ...
                    memoryManagement = [r'Disable-MMAgent -MemoryCompression',
                    ...
                    powerThrottling = [r'reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Power\PowerThrottling /v PowerThrottlingOff /t REG_DWORD /d 1 /f'])
    
    def activation_commands(self):
        return dict(windowsActivation = [r'Changepk.exe /ProductKey VK7JG-NPHTM-C97JM-9MPGT-3V66T'
